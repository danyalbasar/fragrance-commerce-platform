                                                    ...
                                                    {cart?.couponCode ? (
                                                        ...
                                                        <div className="flex flex-row items-center gap-2">
                                                            <input
                                                                ...
                                                                autoComplete="off"
                                                                className="w-0 min-w-0 flex-1 border border-[var(--luxury-line)] bg-[var(--luxury-input)] px-3 py-2.5 text-sm outline-none transition-colors duration-200 focus:border-[var(--luxury-gold)]"
                                                            />
