...
public class SiteSettingsService : ISiteSettingsService
{
    ...
    public async Task SeedDefaultsAsync()
    {
        var defaults = new Dictionary<string, (string Value, string? Description)>
        {
            ...
            // Homepage section eyebrows & headings
            ["hero_eyebrow"] = ("Private Fragrance House", "Homepage hero eyebrow"),
            ["categories_eyebrow"] = ("Enter the House", "Category panels section eyebrow"),
            ["categories_title"] = ("Choose your ritual.", "Category panels section title"),
            ["categories_link_text"] = ("View all products", "Category panels section link text"),
            ["featured_eyebrow"] = ("Featured Collection", "Featured collection section eyebrow"),
            ["best_sellers_eyebrow"] = ("Most Loved", "Best sellers section eyebrow"),
            ["best_sellers_title"] = ("The best sellers.", "Best sellers section title"),
            ["best_sellers_link_text"] = ("View all", "Best sellers section link text"),
            ["new_arrivals_eyebrow"] = ("Just Arrived", "New arrivals section eyebrow"),
            ["new_arrivals_title"] = ("New arrivals.", "New arrivals section title"),
            ["new_arrivals_link_text"] = ("Explore new", "New arrivals section link text"),
            ["brands_eyebrow"] = ("The Houses & Partners", "Brands strip eyebrow"),
            ["maison_notes_eyebrow"] = ("Maison Notes", "Maison notes section eyebrow"),
            ["newsletter_eyebrow"] = ("The List", "Newsletter section eyebrow"),
